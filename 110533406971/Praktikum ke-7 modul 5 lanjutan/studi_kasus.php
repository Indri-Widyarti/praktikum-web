...
<h3> KOMBINASI LIMIT Dan PEMBERIAN HALAMAN </h3>
<body>
...
<thead>
        <tr>
                <td style="background-color:#9999FF" align="center">No.</td>
                <td style="background-color:#9999FF" align="center">NIM</td>
                <td style="background-color:#9999FF" align="center">Nama</td>
                <td style="background-color:#9999FF" align="center">Alamat</td>
        </tr>
</thead>
<tbody>
        <?php
