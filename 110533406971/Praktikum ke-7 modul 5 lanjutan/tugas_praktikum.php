...
<body>
<h3> PENGURUTAN DATA SECARA ASCENDING Dan DESCENDING</h3>
<?php
...
if ($res) {
        ...
        <table border=1 cellpadding=5 cellspacing=1 style="background-color:#FF99FF" style="border:dashed" bordercolor="#990099">
                <tr style="background-color:#9999FF"><th>#</th>
                        <th width=100 style="background-color:#9999FF">NIM</th>
                        <th width=150 style="background-color:#9999FF"><a href="?type=nama&sort=<?php echo $sort_type; ?>">Nama</a></th>
